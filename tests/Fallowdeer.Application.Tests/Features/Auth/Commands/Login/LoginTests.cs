...
using static Application.Features.MainFeatures.Auth.Commands.Login.Login.LoginCommand;
...
namespace StarterProject.Application.Tests.Features.Auth.Commands.Login
{
    public class LoginTests
    {
        ...
        )
        {
           ...
           // _loginCommandHandler = new LoginCommandHandler(_authBusinessRules,_authService,_userService,_authententicatorService);
        }
