...
public class RefreshTokenCommand : IRequest<RefreshedTokensResponse>
{
    ...
    public class RefreshTokenCommandHandler : IRequestHandler<RefreshTokenCommand, RefreshedTokensResponse>
    {
        ...
        {
            Core.Security.Entities.RefreshToken? refreshToken = _authService.GetRefreshTokenByToken(request.RefreshToken);
            ...
            RefreshedTokensResponse refreshedTokensResponse = new() { AccessToken = createdAccessToken, Referer = addedRefreshToken };
