using Application.Features.MainFeatures.UserOperationClaims.Constants;
using Application.Services.Repositories;
using Core.Application.Rules;
using Core.CrossCuttingConcerns.Exceptions.Types;
using Core.Security.Entities;

namespace Application.Features.MainFeatures.UserOperationClaims.Rules;
...
public class UserOperationClaimBusinessRules : BaseBusinessRules
{
    ...
    public async Task UserShouldNotHasOperationClaimAlreadyWhenUpdated(int id, Guid userId, int operationClaimId)
    {
