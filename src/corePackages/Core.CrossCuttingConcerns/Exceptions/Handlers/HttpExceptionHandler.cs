...
public class HttpExceptionHandler : ExceptionHandler
{
    ...
    protected override Task HandleException(OperationFailedException operationFailedException)
    {
        Response.StatusCode = 434;
        string details = new OperationFailedProblemDetails(operationFailedException.Detail,operationFailedException.Errors).AsJson();
        return Response.WriteAsync(details);
    }
}
