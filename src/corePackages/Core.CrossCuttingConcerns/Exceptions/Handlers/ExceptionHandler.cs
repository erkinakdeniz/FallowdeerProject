...
public abstract class ExceptionHandler
{
    public Task HandleExceptionAsync(Exception exception) =>
        exception switch
        {
            ...
            OperationFailedException operationFailedException => HandleException(operationFailedException),
    ...
    protected abstract Task HandleException(OperationFailedException operationFailedException);
