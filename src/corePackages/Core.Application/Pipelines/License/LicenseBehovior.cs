...
namespace Core.Application.Pipelines.License;
public class LicenseBehovior<TRequest, TResponse> : IPipelineBehavior<TRequest, TResponse> where TRequest :IRequest<TResponse>, ILicenseControl
{
    private readonly IConfiguration _configuration;
    private readonly IHttpContextAccessor _httpContext;

    public LicenseBehovior(IConfiguration configuration, IHttpContextAccessor httpContext)
    {
    ...
    {
        //[{id:2,name:"uyg2",startDate:"28.02.2024",endDate:"4.04.2024"}]
        //
